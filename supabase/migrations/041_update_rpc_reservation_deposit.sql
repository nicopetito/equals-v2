-- Actualiza rpc_reservation_deposit para setear transaction_kind='reserve_deposit'.
-- Los depósitos a reserva no son gastos reales: es dinero apartado internamente.
...
BEGIN
  ...
  VALUES
    (v_user_id, v_desc, p_amount, 'expense', v_res_currency, p_wallet_id, p_date,
     'reservation_deposit', v_notes, false, false, 'reserve_deposit')
