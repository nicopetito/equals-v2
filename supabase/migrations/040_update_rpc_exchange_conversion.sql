-- Actualiza rpc_exchange_conversion para setear transaction_kind='transfer'
-- y transfer_group_id en ambas piernas de la conversión.
-- Las conversiones entre divisas son movimientos internos (no inflan income/expense).
...
BEGIN
  ...
  INSERT INTO public.transactions
    (user_id, description, amount, type, currency, wallet_id, date,
     label, notes, is_recurring, transaction_kind, transfer_group_id)
  VALUES
    (v_user_id, p_description, p_from_amount, 'expense', p_from_currency, p_from_wallet_id, p_date,
     'internal_transfer', v_notes, false, 'transfer', v_conversion_id)
  ...
  INSERT INTO public.transactions
    (user_id, description, amount, type, currency, wallet_id, date,
     label, notes, is_recurring, transaction_kind, transfer_group_id)
  VALUES
    (v_user_id, p_description, p_to_amount, 'income', p_to_currency, p_to_wallet_id, p_date,
     'internal_transfer', v_notes, false, 'transfer', v_conversion_id)
...
GRANT  EXECUTE ON FUNCTION public.rpc_exchange_conversion(uuid,uuid,numeric,numeric,text,text,numeric,text,text,date,text) TO authenticated;
