-- Actualiza rpc_correct_yield_transaction para setear transaction_kind='yield'
-- en la transacción de corrección. Las correcciones son parte del concepto de rendimiento.
